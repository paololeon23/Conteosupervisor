/** Iconos SVG estilo Lucide — sin emojis, offline-friendly */
const PATHS = {
...
export function icon(name, size = 18, className = '') {
  const inner = PATHS[name] || PATHS.inbox;
...
export function iconLabel(name, text, className = '') {
  return `<span class="icon-label ${className}">${icon(name, 16)}<span>${text}</span></span>`;
}
